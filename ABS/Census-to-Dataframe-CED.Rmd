...
abs2006_e07 <- data.frame(ID = 0, Electorate = CED_list_2006_e07$Electorate, State = CED_list_2006_e07$State, Population = 0, Area = 0, MedianPersonalIncome = 0, Unemployed = 0, LFParticipation = 0, Bachelor = 0, Postgraduate = 0, Christianity = 0, Catholic = 0, Buddhism = 0, Islam = 0, Judaism = 0, NoReligion = 0, Age00_04 = 0, Age05_14 = 0, Age15_19 = 0, Age20_24 = 0, Age25_34 = 0, Age35_44 = 0, Age45_54 = 0, Age55_64 = 0, Age65_74 = 0, Age75_84 = 0, Age85plus = 0, BornOverseas = 0, Indigenous = 0, EnglishOnly = 0, OtherLanguageHome = 0, Married = 0, DeFacto = 0, FamilyRatio = 0, CurrentlyStudying = 0, HighSchool = 0, InternetUse = 0, InternetAccess = 0, AusCitizen = 0, AverageHouseholdSize = 0, MedianHouseholdIncome = 0, MedianFamilyIncome = 0, MedianRent = 0, MedianLoanPay = 0, MedianAge = 0, EmuneratedElsewhere = 0, Volunteer = 0, PersonalIncome_NS = 0, FamilyIncome_NS = 0, HouseholdIncome_NS = 0, Rent_NS = 0, Religion_NS = 0, BornOverseas_NS = 0, Language_NS = 0, Tenure_NS = 0, HighSchool_NS = 0, InternetUse_NS = 0, University_NS = 0, Volunteer_NS = 0, InternetAccess_NS = 0, SP_House = 0, Couple_NoChild_House = 0, OneParent_House = 0, Couple_WChild_House = 0, Owned = 0, Mortgage = 0, Renting = 0, PublicHousing = 0, Born_UK = 0, Born_SE_Europe = 0, Born_MidEast = 0, Born_Asia = 0, DiffAddress = 0, Extractive = 0, Transformative = 0, Distributive = 0, Finance = 0, SocialServ = 0, ManagerAdminClericalSales = 0, Professional = 0, Tradesperson = 0, Laborer = 0, DipCert = 0, Anglican = 0, OtherChrist = 0, Other_NonChrist = 0)
```
...
#Birthplace
abs2001$Born_MidEast[i] = (as.numeric(temp_sheet[30,4]) / (as.numeric(temp_sheetB[37,4])- as.numeric(temp_sheetB[34,4]) -  as.numeric(temp_sheet[35,4]))) * 100 #only % of respondents

abs2001$Born_SE_Europe[i] = (as.numeric(temp_sheet[25,4]) / (as.numeric(temp_sheetB[37,4])- as.numeric(temp_sheetB[34,4]) -  as.numeric(temp_sheet[35,4]))) * 100 #only % of respondents

abs2001$Born_UK[i] = (as.numeric(temp_sheet[14,4]) / (as.numeric(temp_sheetB[37,4])- as.numeric(temp_sheetB[34,4]) -  as.numeric(temp_sheet[35,4]))) * 100 #only % of respondents

abs2001$Born_Asia[i] = ((as.numeric(temp_sheet[37,4]) + as.numeric(temp_sheetB[11,4]) + as.numeric(temp_sheetB[17,4])) / (as.numeric(temp_sheetB[37,4])- as.numeric(temp_sheetB[34,4]) -  as.numeric(temp_sheet[35,4]))) * 100 #only % of respondents
...
#Metric
abs2001$Christianity[i] = (as.numeric(temp_sheet[27,4])/question_popl)*100
abs2001$Catholic[i] = (as.numeric(temp_sheet[13,4])/question_popl)*100
abs2001$Anglican[i] = (as.numeric(temp_sheet[10,4])/question_popl)*100

abs2001$OtherChrist[i] = ((as.numeric(temp_sheet[27,4]) - as.numeric(temp_sheet[10,4]) - as.numeric(temp_sheet[13,4]))/question_popl)*100

abs2001$Buddhism[i] = (as.numeric(temp_sheet[8,4])/question_popl)*100
abs2001$Islam[i] = (as.numeric(temp_sheet[29,4])/question_popl)*100
abs2001$Judaism[i] = (as.numeric(temp_sheet[30,4])/question_popl)*100
abs2001$NoReligion[i] = (as.numeric(temp_sheet[35,4])/question_popl)*100
...
abs2001$HighSchool[i] = (as.numeric(temp_sheet[12,4])/question_popl) * 100
abs2001$HighSchool_NS[i] = (as.numeric(temp_sheet[15,4]) / as.numeric(temp_sheet[17,4]))*100 #not stated out of the over 15 population
}
```
...
abs2001$InternetUse[i] = (as.numeric(temp_sheet[16,4])/question_popl) * 100
}
```
...
abs2001$Bachelor[i] = (as.numeric(temp_sheet[10,4]) / question_popl) * 100
abs2001$Postgraduate[i] = (as.numeric(temp_sheet[8,4]) / question_popl) * 100
...
abs2001$DipCert[i] = ((as.numeric(temp_sheet[11,4]) + as.numeric(temp_sheet[12,4]))/ question_popl) * 100
}
```
...
abs2001$Extractive[i] = ((as.numeric(temp_sheet[10,9]) + as.numeric(temp_sheet[11,9]) + as.numeric(temp_sheet[13,9])) / question_popl) * 100
abs2001$Transformative[i] = ((as.numeric(temp_sheet[12,9]) + as.numeric(temp_sheet[14,9])) / question_popl) * 100
abs2001$Distributive[i] = ((as.numeric(temp_sheet[15,9]) + as.numeric(temp_sheet[16,9]) + as.numeric(temp_sheet[18,9])) / question_popl) * 100
abs2001$Finance[i] = (as.numeric(temp_sheet[20,9]) / question_popl) * 100
abs2001$SocialServ[i] = ((as.numeric(temp_sheet[23,9]) + as.numeric(temp_sheet[24,9]) + as.numeric(temp_sheet[25,9])) / question_popl) * 100
}
...
# Occupation 
abs2001$ManagerAdminClericalSales[i] = ((as.numeric(temp_sheet[10,9]) + as.numeric(temp_sheet[14,9]) + as.numeric(temp_sheet[15,9]) + as.numeric(temp_sheet[17,9])) / question_popl) * 100
abs2001$Professional[i] = ((as.numeric(temp_sheet[11,9])) / question_popl) * 100
abs2001$Tradesperson[i] = (as.numeric(temp_sheet[13,9]) / question_popl) * 100
abs2001$Laborer[i] = (as.numeric(temp_sheet[18,9]) / question_popl) * 100
...
abs2006$Born_MidEast[i] = ((
  as.numeric(temp_sheet[14,4]) + as.numeric(temp_sheet[22,4]) + as.numeric(temp_sheet[27,4]) + as.numeric(temp_sheet[40,4]) + as.numeric(temp_sheet[14,4]) ) / question_popl) * 100 

abs2006$Born_SE_Europe[i] = ((
  as.numeric(temp_sheet[10,4]) + as.numeric(temp_sheet[13,4]) + as.numeric(temp_sheet[16,4]) + as.numeric(temp_sheet[18,4]) + as.numeric(temp_sheet[37,4]) ) / question_popl) * 100 

abs2006$Born_UK[i] = (as.numeric(temp_sheet[41,4]) / question_popl) * 100 #only % of respondents

abs2006$Born_Asia[i] = ((
  as.numeric(temp_sheet[12,4]) + as.numeric(temp_sheet[20,4]) + as.numeric(temp_sheet[21,4]) + as.numeric(temp_sheet[25,4]) + as.numeric(temp_sheet[26,4]) + as.numeric(temp_sheet[28,4]) + as.numeric(temp_sheet[33,4]) + as.numeric(temp_sheet[35,4]) + as.numeric(temp_sheet[38,4]) + as.numeric(temp_sheet[39,4]) + as.numeric(temp_sheet[43,4]) ) / question_popl) * 100 
...
#Religion
abs2006$Christianity[i] = (as.numeric(temp_sheet[31,4])/question_popl)*100
abs2006$Catholic[i] = (as.numeric(temp_sheet[16,4])/question_popl)*100
abs2006$Anglican[i] = (as.numeric(temp_sheet[12,4])/question_popl)*100
abs2006$Buddhism[i] = (as.numeric(temp_sheet[10,4])/question_popl)*100
abs2006$Islam[i] = (as.numeric(temp_sheet[33,4])/question_popl)*100
abs2006$Judaism[i] = (as.numeric(temp_sheet[34,4])/question_popl)*100
abs2006$NoReligion[i] = (as.numeric(temp_sheet[39,4])/question_popl)*100

abs2006$OtherChrist[i] = ((as.numeric(temp_sheet[31,4]) - as.numeric(temp_sheet[12,4]) - as.numeric(temp_sheet[16,4]))/question_popl)*100
...
#Percentage of total population that have finished high school
abs2006$HighSchool[i] = (as.numeric(temp_sheet[39,11])/question_popl) * 100
...
abs2006$Volunteer[i] = (as.numeric(temp_sheet[48,2])/question_popl) * 100
...
abs2006$Owned[i] = (as.numeric(temp_sheet[12,7])/(as.numeric(temp_sheet[29,7])-as.numeric(temp_sheet[27,7]))) * 100
abs2006$Mortgage[i] = (as.numeric(temp_sheet[14,7])/(as.numeric(temp_sheet[29,7])-as.numeric(temp_sheet[27,7]))) * 100
abs2006$Renting[i] = (as.numeric(temp_sheet[23,7])/(as.numeric(temp_sheet[29,7])-as.numeric(temp_sheet[27,7]))) * 100
abs2006$PublicHousing[i] = (as.numeric(temp_sheet[18,7])/(as.numeric(temp_sheet[29,7])-as.numeric(temp_sheet[27,7]))) * 100
...
#Bachelor and Postgraduate
abs2006$Bachelor[i] = (as.numeric(temp_sheet[15,10]) / question_popl) * 100
abs2006$DipCert[i] = ((as.numeric(temp_sheet[17,10])+as.numeric(temp_sheet[23,10])) / question_popl) * 100
abs2006$Postgraduate[i] = (as.numeric(temp_sheet[11,10]) / question_popl) * 100
...
# Industry of employment
abs2006$Extractive[i] = ((as.numeric(temp_sheet[11,11]) + as.numeric(temp_sheet[12,11]) + as.numeric(temp_sheet[14,11])) / question_popl) * 100
abs2006$Transformative[i] = ((as.numeric(temp_sheet[13,11]) + as.numeric(temp_sheet[15,11])) / question_popl) * 100
abs2006$Distributive[i] = ((as.numeric(temp_sheet[16,11]) + as.numeric(temp_sheet[17,11]) + as.numeric(temp_sheet[19,11])) / question_popl) * 100
abs2006$Finance[i] = (as.numeric(temp_sheet[21,11]) / question_popl) * 100
abs2006$SocialServ[i] = ((as.numeric(temp_sheet[26,11]) + as.numeric(temp_sheet[27,11]) + as.numeric(temp_sheet[28,11])) / question_popl) * 100
}
```
...
# Occupation 
abs2006$ManagerAdminClericalSales[i] = ((as.numeric(temp_sheet[51,2]) + as.numeric(temp_sheet[51,6]) + as.numeric(temp_sheet[51,7])) / question_popl) * 100
abs2006$Professional[i] = ((as.numeric(temp_sheet[51,3])) / question_popl) * 100
abs2006$Tradesperson[i] = (as.numeric(temp_sheet[51,4]) / question_popl) * 100
abs2006$Laborer[i] = (as.numeric(temp_sheet[51,9]) / question_popl) * 100
...
abs2006_e07$Born_UK[i] = (as.numeric(temp_sheet[41,4]) / question_popl) * 100 #only % of respondents
...
#Religion
abs2006_e07$Christianity[i] = (as.numeric(temp_sheet[31,4])/question_popl)*100
abs2006_e07$Catholic[i] = (as.numeric(temp_sheet[16,4])/question_popl)*100
abs2006_e07$Anglican[i] = (as.numeric(temp_sheet[12,4])/question_popl)*100
abs2006_e07$Buddhism[i] = (as.numeric(temp_sheet[10,4])/question_popl)*100
abs2006_e07$Islam[i] = (as.numeric(temp_sheet[33,4])/question_popl)*100
abs2006_e07$Judaism[i] = (as.numeric(temp_sheet[34,4])/question_popl)*100
abs2006_e07$NoReligion[i] = (as.numeric(temp_sheet[39,4])/question_popl)*100

abs2006_e07$OtherChrist[i] = ((as.numeric(temp_sheet[31,4]) - as.numeric(temp_sheet[12,4]) - as.numeric(temp_sheet[16,4]))/question_popl)*100
...
#Percentage of total population that have finished high school
abs2006_e07$HighSchool[i] = (as.numeric(temp_sheet[39,11])/question_popl) * 100
...
#Percentage of people over 15 who volunteer
abs2006_e07$Volunteer[i] = (as.numeric(temp_sheet[48,2])/question_popl) * 100
...
#Percentage of total population that do not own/mortgage their dwelling
abs2006_e07$Owned[i] = (as.numeric(temp_sheet[12,7])/(as.numeric(temp_sheet[29,7])-as.numeric(temp_sheet[27,7]))) * 100
abs2006_e07$Mortgage[i] = (as.numeric(temp_sheet[14,7])/(as.numeric(temp_sheet[29,7])-as.numeric(temp_sheet[27,7]))) * 100
abs2006_e07$Renting[i] = (as.numeric(temp_sheet[23,7])/(as.numeric(temp_sheet[29,7])-as.numeric(temp_sheet[27,7]))) * 100
abs2006_e07$PublicHousing[i] = (as.numeric(temp_sheet[18,7])/(as.numeric(temp_sheet[29,7])-as.numeric(temp_sheet[27,7]))) * 100
...
#Percentage of Dwellings with internet access
abs2006_e07$InternetAccess[i] = (as.numeric(temp_sheet[16,7]) / (as.numeric(temp_sheet[20,7]) - as.numeric(temp_sheet[18,7]))) * 100 #excludes not stated
...
# Different address to 5 years ago
abs2006_e07$DiffAddress[i] = as.numeric(temp_sheet[27,4])/(as.numeric(temp_sheet[31,4])-as.numeric(temp_sheet[29,4])) * 100
}
```
...
#Bachelor and Postgraduate
abs2006_e07$Bachelor[i] = (as.numeric(temp_sheet[15,10]) / question_popl) * 100
abs2006_e07$DipCert[i] = ((as.numeric(temp_sheet[13,10]) + as.numeric(temp_sheet[17,10])+as.numeric(temp_sheet[23,10])) / question_popl) * 100
abs2006_e07$Postgraduate[i] = (as.numeric(temp_sheet[11,10]) / question_popl) * 100
...
# Industry of employment
abs2006_e07$Extractive[i] = ((as.numeric(temp_sheet[11,11]) + as.numeric(temp_sheet[12,11]) + as.numeric(temp_sheet[14,11])) / question_popl) * 100
abs2006_e07$Transformative[i] = ((as.numeric(temp_sheet[13,11]) + as.numeric(temp_sheet[15,11])) / question_popl) * 100
abs2006_e07$Distributive[i] = ((as.numeric(temp_sheet[16,11]) + as.numeric(temp_sheet[17,11]) + as.numeric(temp_sheet[19,11])) / question_popl) * 100
abs2006_e07$Finance[i] = (as.numeric(temp_sheet[21,11]) / question_popl) * 100
abs2006_e07$SocialServ[i] = ((as.numeric(temp_sheet[26,11]) + as.numeric(temp_sheet[27,11]) + as.numeric(temp_sheet[28,11])) / question_popl) * 100
}
```
...
# Occupation 
abs2006_e07$ManagerAdminClericalSales[i] = ((as.numeric(temp_sheet[51,2]) + as.numeric(temp_sheet[51,6]) + as.numeric(temp_sheet[51,7])) / question_popl) * 100
abs2006_e07$Professional[i] = ((as.numeric(temp_sheet[51,3])) / question_popl) * 100
abs2006_e07$Tradesperson[i] = (as.numeric(temp_sheet[51,4]) / question_popl) * 100
abs2006_e07$Laborer[i] = (as.numeric(temp_sheet[51,9]) / question_popl) * 100
...
abs2001$Electorate[117] <- "O'Connor"
abs2001$Electorate <- toupper(abs2001$Electorate)
abs2001$Electorate <- as.factor(abs2001$Electorate)

abs2006$Electorate <- toupper(abs2006$Electorate)
abs2006_e07$Electorate <- toupper(abs2006_e07$Electorate)
