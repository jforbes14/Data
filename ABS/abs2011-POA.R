...
B1_Main <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B01_AUST_POA_short.csv")
B02_Medians <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B02_AUST_POA_short.csv")
B06_Marriage <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B06_AUST_POA_short.csv")
B09_BornOverseas <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B09_AUST_POA_short.csv")
B13_LanguageHome <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B13_AUST_POA_short.csv")
B14_Religion <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B14_AUST_POA_short.csv")
B15_Study <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B15_AUST_POA_short.csv")
B16A_HighSchool <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B16A_AUST_POA_short.csv")
B16B_HighSchool <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B16B_AUST_POA_short.csv")
B17B_Income <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B17B_AUST_POA_short.csv")
B19_Volunteer <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B19_AUST_POA_short.csv")
B25_Family <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B25_AUST_POA_short.csv")
B26_FamilyIncome <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B26_AUST_POA_short.csv")
B28_HouseholdIncome <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B28_AUST_POA_short.csv")
B30_NumberInHouse <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B30_AUST_POA_short.csv")
B32_Tenure <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B32_AUST_POA_short.csv")
B34_Rent <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B34_AUST_POA_short.csv")
B35_Internet <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B35_AUST_POA_short.csv")
B37_Employ <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B37_AUST_POA_short.csv")
B39_Address <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B39_AUST_POA_short.csv")
B40B_Uni <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B40B_AUST_POA_short.csv")
B43C_Industry <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B43C_AUST_POA_short.csv")
B43D_Industry <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B43D_AUST_POA_short.csv")
B45B_Occupation <- read_csv("./2011_BCP_POA_for_AUST_short-header/2011 Census BCP Postal Areas for AUST/AUST/2011Census_B45B_AUST_POA_short.csv")



new_POA_abs2011 <- B1_Main %>% mutate(
  POA = region_id,
  ...
  #B14
  Christianity = (B14_Religion$Christianity_Tot_P/(B14_Religion$Tot_P - B14_Religion$Religious_affiliation_ns_P))*100,
  Anglican = (B14_Religion$Christianity_Anglican_P/(B14_Religion$Tot_P - B14_Religion$Religious_affiliation_ns_P))*100,
  Catholic = (B14_Religion$Christianity_Catholic_P/(B14_Religion$Tot_P - B14_Religion$Religious_affiliation_ns_P))*100,
  Buddhism = (B14_Religion$Buddhism_P/(B14_Religion$Tot_P - B14_Religion$Religious_affiliation_ns_P))*100,
  Islam = (B14_Religion$Islam_P/(B14_Religion$Tot_P - B14_Religion$Religious_affiliation_ns_P))*100,
  Judaism = (B14_Religion$Judaism_P/(B14_Religion$Tot_P - B14_Religion$Religious_affiliation_ns_P))*100,
  NoReligion = (B14_Religion$No_Religion_P/(B14_Religion$Tot_P - B14_Religion$Religious_affiliation_ns_P))*100,
  OtherChrist = ((B14_Religion$Christianity_Tot_P - B14_Religion$Christianity_Anglican_P - B14_Religion$Christianity_Catholic_P)/(B14_Religion$Tot_P - B14_Religion$Religious_affiliation_ns_P))*100,
  Religion_NS = (B14_Religion$Religious_affiliation_ns_P/B14_Religion$Tot_P)*100,
  #Other_NonChrist = 100 - NoReligion - Christianity,
  #Other_NonChrist = (1- ((B14_Religion$Christianity_Tot_P + B14_Religion$No_Religion_P)/(B14_Religion$Tot_P - B14_Religion$Religious_affiliation_ns_P)))*100,
  ...
  DipCert = ifelse(DipCert > 100, 100, DipCert), #To cap at 100%
...
# Trim
POA_abs2011 <- new_POA_abs2011[, c(110:ncol(new_POA_abs2011))]

# Order by post code
POA_abs2011 <- POA_abs2011[order(POA_abs2011$POA),]

# Area
Area_POA_11 <- read_excel("./2011_BCP_POA_for_AUST_short-header/Metadata/2011Census_geog_desc_1st_and_2nd_release.xlsx", sheet = 1) %>%
  filter(Level == "POA")
Area_POA_11 <- Area_POA_11[order(Area_POA_11$Code),]
POA_abs2011$Area <- Area_POA_11$`Area sqkm`

# Change any Inf and NaN to NA
for (i in 1:ncol(POA_abs2011)) {
  POA_abs2011[which(is.nan(POA_abs2011[,i] %>% unlist)), i] <- NA
  POA_abs2011[which(is.infinite(POA_abs2011[,i] %>% unlist)), i] <- NA
}
# Check: sapply(POA_abs2011, is.infinite) %>% sum

# Remove prefix from POA
POA_abs2011$POA <- substr(POA_abs2011$POA, 4, 7)

# Check that min/max for each metric are [0,100]
POA_abs2011[,-1] %>% sapply(quantile, na.rm = TRUE) %>% t() %>% View()

# inflation
inflation_rates <- c(1.151, 1.330, 1.461)
POA_abs2011 <- POA_abs2011 %>%
...
# Change BornOverseas to BornElsewhere, add Other_NonChrist
POA_abs2011 <- POA_abs2011 %>%
  mutate(BornElsewhere = BornOverseas - Born_MidEast - Born_SE_Europe - Born_UK) %>% 
  select(-BornOverseas) %>% 
  mutate(Other_NonChrist = 100 - NoReligion - Christianity)

# Save
save(POA_abs2011, file = "/Users/Jeremy/Documents/R/Data/Clean/POA_abs2011.rda")
