...
nms <- simp_abs16@data %>% select(CED_NAME)
...
fortified_2013 <- ggplot2::fortify(simp_aec13) %>% 
  mutate(year = "2013",
         group = paste0("g.", group),
         piece = paste0("p.", piece))
nms <- simp_aec13@data %>% select(Elect_div)
nms$id <- as.character(1:150)
...
fortified_2010 <- ggplot2::fortify(simp_aec10) %>% 
  mutate(year = "2010",
         group = paste0("g.", group),
         piece = paste0("p.", piece))
nms <- simp_aec10@data %>% select(ELECT_DIV)
nms$id <- as.character(1:150)
...
fortified_2007 <- ggplot2::fortify(simp_abs06e07) %>% 
  mutate(year = "2007",
         group = paste0("g.", group),
         piece = paste0("p.", piece))
nms <- simp_abs06e07@data %>% select(NAME_2007)
nms$id <- as.character(1:150)
...
fortified_2004 <- ggplot2::fortify(simp_abs06e04) %>% 
  mutate(year = "2004",
         group = paste0("g.", group),
         piece = paste0("p.", piece))
nms <- simp_abs06e04@data %>% select(NAME_2004)
nms$id <- as.character(1:150)
...
fortified_2001 <- ggplot2::fortify(simp_abs01) %>% 
  mutate(year = "2001",
         group = paste0("g.", group),
         piece = paste0("p.", piece))
nms <- simp_abs01@data %>% select(CED_NAME_2001)
nms$id <- as.character(1:150)
